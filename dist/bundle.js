...
const removeTaskButtonEl = () => {
  ...
  htmlCheckboxes.forEach((checkbox) => {
    checkbox.addEventListener('click', (e) => {
      ...
      removeTaskButtonEl();
      taskTitleEl();
      _project__WEBPACK_IMPORTED_MODULE_1__.projectlist.saveProjects();
    });
  });
};
  ...
  btn.addEventListener(
    ...
    (e) => {
      ...
      _project__WEBPACK_IMPORTED_MODULE_1__.projectlist.getActiceProjectObject()
        .addTask((0,_task__WEBPACK_IMPORTED_MODULE_2__.newTask)(titleInput.value, descriptionInput.value, dateInput));
      (0,_pageLoad__WEBPACK_IMPORTED_MODULE_0__.displayTaskList)();
      (0,_pageLoad__WEBPACK_IMPORTED_MODULE_0__.displayProjectlist)();
      projectListItemEl();
      removeTaskButtonEl();
...
class Task {
  ...
  set dueDate(dueDate) {
    this.#dueDate = dueDate === '' ? '' : (0,date_fns__WEBPACK_IMPORTED_MODULE_0__["default"])(dueDate, 'hh:mm - dd.MM.yyyy');
  }
...
if (!_modules_project__WEBPACK_IMPORTED_MODULE_2__.projectlist.loadProjects()) {
